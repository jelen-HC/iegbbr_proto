...
class PartOneThree extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: MyDrawer(appScreen: 'partOneThree'),
      body: Filter(
        pageContent: Consumer<MemberNotifier>(
          builder: (context, tabBar, child) {

            /// Takes lists from "memberNotifier" and creates new lists to insert the "PartOneThree Tab"
            ...
            setPartOneThreeTab() {
              ...
              _newMemberTabs.insert(0, part1_3Tab);
              _newMemberPages.insert(0, part1_3);
            }
            setPartOneThreeTab();

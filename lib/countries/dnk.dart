      ...
      child: Container(
        ...
        child: FutureBuilder(
          ...
          builder: (context, AsyncSnapshot<dynamic> snapshot) {
            final tableTitleOne = snapshot.hasData ? snapshot.data[0]['en']['dnk'][0]['partOneOne']['titleTableOne'] : 'loading...';
            final tableTitleTwo = snapshot.hasData ? snapshot.data[0]['en']['dnk'][0]['partOneOne']['titleTableTwo'] : '';
